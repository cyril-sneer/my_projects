...
class TestAvg:
    def __init__(self):
        ...
        self.calc_button = tkinter.Button(self.button_frame, text='Усреднить', command=self.calc_avg)
        self.quit_button = tkinter.Button(self.button_frame, text='Выйти', command=self.main_window.destroy)
        self.calc_button.pack(side='left')
        self.quit_button.pack(side='left')

        # Упаковать рамки.
        self.test1_frame.pack(padx=20)
        self.test2_frame.pack(padx=20)
        self.test3_frame.pack(padx=20)
        self.avg_frame.pack(padx=20)
    ...
    # для виджета calc_button.

    def calc_avg(self):
        # Получить три экзаменационные оценки и
        ...
        # Обновить виджет avg_label widget,
