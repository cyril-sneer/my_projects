# Эта программа чертит круговую диаграмму на виджете Canvas.
import tkinter
...
class MyGUI:
    def __init__(self):
        ...
        self.canvas.create_arc(self.__X1, self.__Y1, self.__X2, self.__Y2,
                               start=self.__PIE1_START, extent=self.__PIE1_WIDTH, fill='red')

        # Начертить сектор 2.
        self.canvas.create_arc(self.__X1, self.__Y1, self.__X2, self.__Y2,
                               start=self.__PIE2_START, extent=self.__PIE2_WIDTH, fill='green')

        # Начертить сектор 3.
        self.canvas.create_arc(self.__X1, self.__Y1, self.__X2, self.__Y2,
                               start=self.__PIE3_START, extent=self.__PIE3_WIDTH, fill='black')

        # Начертить сектор 4.
        self.canvas.create_arc(self.__X1, self.__Y1, self.__X2, self.__Y2,
                               start=self.__PIE4_START, extent=self.__PIE4_WIDTH, fill='yellow')
